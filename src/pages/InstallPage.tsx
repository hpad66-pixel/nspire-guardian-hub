...
const iosSteps = [
  ...
  { icon: CheckCircle2, text: 'Tap "Add" in the top-right corner. Build Space OS will appear on your home screen like a native app.' },
];
...
const androidSteps = [
  ...
  { icon: CheckCircle2, text: 'Confirm by tapping "Install". Build Space OS will appear on your home screen.' },
];
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="border-b border-border px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src="/icons/apas-os-192.png" alt="Build Space OS" className="h-8 w-8 rounded-lg" />
          <span className="font-semibold text-foreground">Build Space OS</span>
        </div>
        <Link to="/auth">
      ...
      <main className="flex-1 px-4 py-10 max-w-2xl mx-auto w-full space-y-12">
        ...
        <div className="text-center space-y-4">
          <div className="h-20 w-20 mx-auto rounded-2xl overflow-hidden shadow-lg">
            <img src="/icons/apas-os-512.png" alt="Build Space OS" className="w-full h-full object-cover" />
          </div>
          <h1 className="text-3xl font-bold tracking-tight">Install Build Space OS</h1>
          <p className="text-muted-foreground max-w-sm mx-auto">
            Add Build Space OS to your home screen for fast, offline-capable access — no app store required.
          </p>
          <Link to="/portals">
        ...
        <section className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground text-sm">
            Scan this QR code with your phone to open Build Space OS on mobile, then follow the steps above.
          </p>
      ...
      <footer className="border-t border-border px-4 py-6 text-center">
        <p className="text-xs text-muted-foreground">Build Space OS — One platform to run everything.</p>
      </footer>
    </div>
  );
}
