          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <div className="hidden lg:flex gap-6 items-start">
              ...
              <div className="flex-1 min-w-0 space-y-4">
                <TabsContent value="overview" className="space-y-6 mt-0">
                  ...
                  <div className="rounded-xl border bg-card p-5 space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Button size="sm" variant="outline" className="h-7 text-xs gap-1" onClick={() => setTeamSheetOpen(true)}><Users className="h-3 w-3" />People &amp; Team</Button>
                    </div>
                ...
                <TabsContent value="action-items" className="mt-0"><ActionItemsTab projectId={id!} projectName={project.name} /></TabsContent>
            ...
            {/* ── MOBILE: active-tab pill + badge jumps (<768px) ── */}
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  {isPermits ? (
                                    <p className="text-[10px] text-[var(--apas-sapphire)] font-semibold mt-0.5 leading-none">Register and capture</p>
                                  ) : tab.badge !== null ? (
            ...
            <div className="lg:hidden mt-2 space-y-4">
              ...
              <TabsContent value="action-items"><ActionItemsTab projectId={id!} projectName={project.name} /></TabsContent>
