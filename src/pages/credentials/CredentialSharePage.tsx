      ...
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <div className="mb-8 flex items-center justify-center gap-2">
            ...
            <span className="text-lg font-bold text-foreground">APAS Project Controls</span>
          </div>
          ...
          <div className="rounded-2xl border bg-card p-8 shadow-sm">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              generate a new share link from their projOS profile.
            </p>
          </div>

          <p className="mt-6 text-xs text-muted-foreground">
            Verified via{' '}
            <a href="https://projos.ai" className="text-primary hover:underline">
              APAS Project Controls · projos.ai
            </a>
          </p>
        </div>
      </div>
