        ...
        <div className="max-w-sm w-full text-center space-y-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              This certificate link is no longer active. Ask the certificate holder to generate a new share link from their Build Space OS profile.
            </p>
          </div>
          <p className="text-xs text-muted-foreground">
            Powered by{' '}
            <a href="https://apasos.ai" className="text-primary hover:underline">Build Space OS · apasos.ai</a>
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="max-w-sm w-full space-y-6">
        ...
        <div className="text-center">
          <span className="text-lg font-black tracking-tight text-foreground">Build Space OS</span>
        </div>
