              ...
              <div className="space-y-3 mb-5">
                {isAuth0SignInEnabled() && (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 h-12 rounded-xl text-sm font-semibold border border-primary/15 bg-primary text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-60"
                  >
                    {isAuth0Loading ? (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 h-12 rounded-xl text-sm font-medium border border-border bg-background text-foreground transition-colors hover:bg-muted disabled:opacity-60"
                >
                  {isGoogleLoading ? (
