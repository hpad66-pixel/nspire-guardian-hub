...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. Proj OS is a Progressive Web App — install it from any browser on iPhone or Android. Inspections, photos, voice notes, and work orders all work offline. Data syncs automatically when you're back online. No app store required.",
  },
  {
