    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            Most PMs manage construction and compliance on the same day. Build OS is the only platform that connects both — one login, one dashboard, complete visibility.
          </p>
        </motion.div>
