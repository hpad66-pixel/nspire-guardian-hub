...
const modules: ModuleProps[] = [
  ...
  },
  {
    ...
    description: 'Fire safety certificates. Elevator inspections. Stormwater permits. One missed deadline can mean shutdown, fines, or liability. Proj OS tracks every one.',
    points: [
