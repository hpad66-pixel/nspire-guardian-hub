...
const modules: ModuleProps[] = [
  ...
  },
  {
    ...
    description: 'Fire safety certificates. Elevator inspections. Stormwater permits. One missed deadline can mean shutdown, fines, or liability. Build OS tracks every one.',
    points: [
