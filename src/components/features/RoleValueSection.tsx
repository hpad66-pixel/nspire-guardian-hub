...
const roles = [
  {
    ...
    description: 'You own the asset. You carry the liability. Build Space OS gives you visibility into every inspection, open issue, permit expiry, and maintenance dollar — without having to ask anyone.',
    color: '#8B5CF6',
  },
  {
    icon: Briefcase,
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          <h2 style={{ fontFamily: 'Instrument Serif', fontSize: 'clamp(28px, 4.5vw, 52px)', color: 'var(--apas-white)', lineHeight: 1.1, marginBottom: '20px' }}>
            Who Build Space OS Is Built For
          </h2>
