  ...
  return (
    <div style={{ background: 'linear-gradient(135deg, #2e1065 0%, #4c1d95 100%)', borderRadius: '14px', padding: '24px', boxShadow: '0 8px 24px rgba(15,23,42,0.15)', maxWidth: '340px' }}>
      ...
      <div style={{ background: 'rgba(255,255,255,0.08)', borderRadius: '10px', padding: '12px' }}>
        ...
        <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '12px', color: 'rgba(255,255,255,0.5)', marginBottom: '4px' }}>Build AI</div>
...
const features: Feature[] = [
  ...
  },
  {
    ...
    body: 'Every permit, certificate, and regulatory filing has its own record in Build OS. Expiration dates are tracked automatically. You get alerts at 90, 60, 30, and 14 days before anything expires.',
  ...
  },
  {
    ...
    body: 'Build OS manages construction and renovation projects end to end. Milestones, daily site reports, formal RFI tracking, submittal logs, change order approvals, punch lists, safety logs, and final closeout documentation.',
