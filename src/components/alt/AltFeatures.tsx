...
const features: Feature[] = [
  ...
  },
  {
    ...
    body: 'Every permit, certificate, and regulatory filing has its own record in Proj OS. Expiration dates are tracked automatically. You get alerts at 90, 60, 30, and 14 days before anything expires.',
  ...
  },
  {
    ...
    body: 'Proj OS manages construction and renovation projects end to end. Milestones, daily site reports, formal RFI tracking, submittal logs, change order approvals, punch lists, safety logs, and final closeout documentation.',
