...
const stats = [
  { value: 500, suffix: '+', label1: 'Teams using', label2: 'Build Space OS' },
...
const testimonials = [
  {
    text: 'We manage 6 properties across 3 cities. Build Space OS replaced four different tools we were paying for and gave us a compliance dashboard I can show any HUD inspector without preparation.',
    author: 'Maria G.',
  ...
  {
    text: 'We run capital improvement projects between $500K and $3M. Tracking RFIs and change orders in Build Space OS is cleaner than Procore and costs a fraction of the price.',
    author: 'David R.',
