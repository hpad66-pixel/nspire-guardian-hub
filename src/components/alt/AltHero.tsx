      ...
      <div className="max-w-[1200px] mx-auto px-6 py-24 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              Build Space OS replaces the spreadsheets, the email chains, the paper checklists, and the filing cabinets that most firms still use. Inspections, compliance, work orders, projects, permits, and team communication — all in one platform.
            </motion.p>
