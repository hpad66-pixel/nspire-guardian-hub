      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          ...
          <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: '18px', color: '#475569', maxWidth: '560px', margin: '0 auto', lineHeight: 1.7 }}>
            Proj OS is not another point solution. It's the operating layer for your entire property and construction operation — where every action is linked, every record is searchable, and nothing falls through the cracks.
          </p>
        </motion.div>
