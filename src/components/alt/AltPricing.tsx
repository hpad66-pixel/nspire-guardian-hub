...
const faqs = [
  ...
  { q: 'Can my inspectors use it offline in the field?', a: 'Yes. Build OS is a Progressive Web App. Install it from your browser on any phone. Inspections, photos, and voice notes work offline and sync automatically when you\'re back online.' },
