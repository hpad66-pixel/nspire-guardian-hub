...
export function PhotoIntelligenceWorkspace({
  ...
  async function generateReport() {
    try { await openFieldPhotoScopeReport({ projectName, photos, items }); }
