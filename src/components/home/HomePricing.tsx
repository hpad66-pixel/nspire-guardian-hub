...
const faqs = [
  ...
  { q: 'Can my inspectors use it offline?', a: 'Yes. Proj OS is a PWA. Install from any browser. Inspections, photos, and voice notes work offline and sync automatically.' },
