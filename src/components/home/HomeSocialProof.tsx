...
const stats = [
  { value: 500, suffix: '+', label: 'Teams using Proj OS' },
...
const testimonials = [
  {
    text: 'We manage 6 properties across 3 cities. Proj OS replaced four different tools and gave us a compliance dashboard we can show any HUD inspector.',
  ...
  {
    text: 'We run capital projects between $500K and $3M. Tracking RFIs and change orders in Proj OS is cleaner than Procore at a fraction of the price.',
