...
const cols = [
  ...
  { title: 'Company', links: ['About Build', 'Contact Us', 'Privacy Policy', 'Terms of Service'] },
];
    ...
    <footer className="border-t border-white/[0.04] py-16" style={{ background: '#0A0B0D' }}>
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-8 border-t border-white/[0.04]">
          <p className="text-[12px] text-white/20" style={{ fontFamily: 'Inter' }}>© 2026 Build · All rights reserved</p>
          <p className="text-[11px] text-white/10" style={{ fontFamily: "'JetBrains Mono'" }}>Built by Build</p>
        </div>
      </div>
    </footer>
  );
